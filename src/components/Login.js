...
export default function Login({setLoginUser}) {
  ...
  return (
    <div id="logindiv">
    <div className='login' >
    <h1 ><img alt={"logo"}src="https://png.pngtree.com/png-vector/20191110/ourmid/pngtree-avatar-icon-profile-icon-member-login-vector-isolated-png-image_1978396.jpg" style={{width:"30%",borderRadius:"50%"}}></img></h1>
